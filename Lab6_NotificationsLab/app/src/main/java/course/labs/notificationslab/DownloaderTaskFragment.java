...
public class DownloaderTaskFragment extends Fragment {
    ...
    static final String TAG_FRIEND_RES_IDS = MainActivity.TAG_FRIEND_RES_IDS;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] mResourcesIds = new Integer[arrayList.size()];

        // Initialize mResourceIds with values from arrayList
        // arrayList must be cast to get Integer[]
        mResourcesIds = (Integer[]) arrayList.toArray(mResourcesIds);

        // TODO: Start the DownloaderTask
        if (mResourcesIds != null)
            downloaderTask.execute(mResourcesIds);
                        ...
                        if (getResultCode() != MainActivity.IS_ALIVE) {
                            ...
                            final PendingIntent pendingIntent =
                                    PendingIntent.getActivity
                                            (mContext, 0, restartMainActivityIntent,
